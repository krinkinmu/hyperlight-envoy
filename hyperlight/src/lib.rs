...
impl<'a> Builder<'a> {
    ...
    fn build(&self) -> LoadedWasmSandbox<'static> {
        ...
        let mut proto_sandbox = self.builder
            .clone()
            .with_guest_heap_size(10*1024*1024)
            .with_guest_stack_size(128*1024)
            .with_host_function_buffer_size(64*1024)
            .with_guest_output_buffer_size(64*1024)
            .with_guest_input_buffer_size(64*1024)
            .with_wasm_heap_size(5*1024*1024)
            .with_wasm_stack_size(64*1024)
